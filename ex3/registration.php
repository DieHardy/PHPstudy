...
<div class="container">
    ...
    <form action="register.php" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="password" class="form-control" id="formGroupExampleInput2" placeholder="Repeat Password" name="reppas">
        </div>
        <button type="submit" class="btn btn-warning">Submit</button>
    </form>
    <p>If you already have an account you can <a href="index.php">login</a> into this.</p>
</div>
